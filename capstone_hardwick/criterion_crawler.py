...
def main():
    ...
    rawg_result_count = 20
    search_response_dict = {}

    url_name = rawg_base_url + games + rawg_api_key + search + searchable_name
    print(url_name)
    ...
    for i in range(rawg_result_count):
        ...
        search_response_dict[name] = [platform, playtime]
        print("\nitem:  ", i)
        print("Result " + str(i+1) + ":  " + name)
        print("Console:  ", platform)
        print("Duration:  ", playtime)
